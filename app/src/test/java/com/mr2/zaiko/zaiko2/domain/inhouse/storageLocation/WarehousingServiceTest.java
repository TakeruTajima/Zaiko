...
import com.mr2.zaiko.zaiko2.domain.inhouse.user.Authority;
...
public class WarehousingServiceTest {
    ...
    public void setUp() throws Exception {
        user = new User("1281", new com.mr2.zaiko.zaiko2.domain.inhouse.user.Name("建", null, "但馬"), Authority.NORMAL);
