...
public class DBAdapter {
    ...
    public Cursor findAllRecords(String tableName, String where){
     ...
     */
    public long updateRecordsById(String tableName, ContentValues values, int _id){
        return db.update(tableName, values, "_id=?", new String[]{""+ _id});
    }

    public long updateRecord(String tableName, ContentValues values, String _id, int unmutatedVersion){
        return db.update(tableName,
                values,
                "unmutated_version = " + unmutatedVersion + "AND _id = ?",
                new String[]{_id});
    }

    public long updateRecords(String tableName, ContentValues values, String where){
        return db.update(tableName,
                values,
                where,
                null);
